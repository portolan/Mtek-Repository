-- Verificar campos nao nulos, EMPRESA sem CNPJ???
...
ALTER TABLE DEPARTAMENTO ADD CONSTRAINT PK_DEPARTAMENTO PRIMARY KEY (DEP_EMPRESAR,DEP_COD);
...
ALTER TABLE DEPARTAMENTO ADD CONSTRAINT FK_DEPARTAMENTO_EMP FOREIGN KEY (DEP_EMPRESAR) REFERENCES EMPRESA (EMP_COD);
