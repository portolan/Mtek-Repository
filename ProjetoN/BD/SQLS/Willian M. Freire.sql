/******************************************************************************/
/***          Generated by IBExpert 2012.02.21 12/11/2015 20:37:18          ***/
/******************************************************************************/
...
SET GENERATOR GEN_BLOCO TO 10;

CREATE GENERATOR GEN_CATEGORIA;
SET GENERATOR GEN_CATEGORIA TO 4;

CREATE GENERATOR GEN_ESTOQUE;
SET GENERATOR GEN_ESTOQUE TO 48;

CREATE GENERATOR GEN_ESTOQ_MOVIMENTO;
SET GENERATOR GEN_ESTOQ_MOVIMENTO TO 137;
...
SET GENERATOR GEN_PRATELEIRA TO 19;

CREATE GENERATOR GEN_PRODUTOS;
SET GENERATOR GEN_PRODUTOS TO 19;
...
ALTER TABLE BLOCO ADD CONSTRAINT FK_REL_BLOC_CATEGORIA FOREIGN KEY (BLOC_EMPRESA, BLOC_CATEGORIA) REFERENCES CATEGORIA (CAT_EMPRESA, CAT_CODIGO);
ALTER TABLE BLOCO ADD CONSTRAINT FK_REL_BLOC_EMPRESA FOREIGN KEY (BLOC_EMPRESA) REFERENCES EMPRESA (EMP_COD);
