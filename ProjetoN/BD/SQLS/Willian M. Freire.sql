/******************************************************************************/
/***          Generated by IBExpert 2012.02.21 11/11/2015 23:53:53          ***/
/******************************************************************************/
...
SET GENERATOR GEN_ESTOQUE TO 44;

CREATE GENERATOR GEN_ESTOQ_MOVIMENTO;
SET GENERATOR GEN_ESTOQ_MOVIMENTO TO 136;
...
SET GENERATOR GEN_PRATELEIRA TO 4;

CREATE GENERATOR GEN_PRODUTOS;
SET GENERATOR GEN_PRODUTOS TO 18;
...
CREATE TABLE PESSOAS (
    ...
    PESS_FISICOJURIDICO  CHAR(1) NOT NULL
);
...
ALTER TABLE BLOCO ADD CONSTRAINT FK_REL_BLOC_CATEGORIA FOREIGN KEY (BLOC_EMPRESA, BLOC_CATEGORIA) REFERENCES BLOCO (BLOC_EMPRESA, BLOC_CODIGO);
