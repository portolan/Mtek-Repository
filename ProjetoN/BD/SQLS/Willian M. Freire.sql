/******************************************************************************/
/***          Generated by IBExpert 2012.02.21 07/11/2015 15:17:03          ***/
/******************************************************************************/
...
SET GENERATOR GEN_ESTOQUE TO 28;
...
SET GENERATOR GEN_PRODUTOS TO 7;
...
ALTER TABLE RELPRODFORN ADD CONSTRAINT FK_REL_RPF_EMPRESA FOREIGN KEY (RPF_EMPRESA) REFERENCES EMPRESA (EMP_COD);
