/******************************************************************************/
/***          Generated by IBExpert 2012.02.21 21/11/2015 17:33:18          ***/
/******************************************************************************/
...
CREATE DATABASE 'C:\Users\Willian\Desktop\Projeto Atual\trunk\ProjetoN\BD\database.fdb'
...
ALTER TABLE DEPARTAMENTO ADD CONSTRAINT PK_DEPARTAMENTO PRIMARY KEY (DEP_COD, DEP_EMPRESAR);
...
ALTER TABLE CHAMADOS ADD CONSTRAINT FK_CHA_DEPARTAMENTO FOREIGN KEY (CHA_CODIGO, CHA_EMPRESA) REFERENCES DEPARTAMENTO (DEP_COD, DEP_EMPRESAR);
...
ALTER TABLE COTACAO ADD CONSTRAINT FK_COTACAO_DEPARTAMENTO FOREIGN KEY (COT_DEPARTAMENTO, COT_EMPRESA) REFERENCES DEPARTAMENTO (DEP_COD, DEP_EMPRESAR);
...
ALTER TABLE PEDIDO_COMPRA ADD CONSTRAINT FK_PEDCOMPRA_DEPARTAMENTO FOREIGN KEY (PDC_DEPARTAMENTO, PDC_EMPRESA) REFERENCES DEPARTAMENTO (DEP_COD, DEP_EMPRESAR);
...
ALTER TABLE SOLICITACAO_COMPRA ADD CONSTRAINT FK_SOLICITACAO_DEPARTAMENTO FOREIGN KEY (SOL_DEPARTAMENTO, SOL_EMPRESA) REFERENCES DEPARTAMENTO (DEP_COD, DEP_EMPRESAR);
...
as
begin
  if (new.emp_cod is null) then
    new.emp_cod = gen_id(gen_empresa_id,1);
end
^
